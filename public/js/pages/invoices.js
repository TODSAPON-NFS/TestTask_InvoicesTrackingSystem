...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Invoices__ = __webpack_require__(43);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__components_Invoices___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__components_Invoices__);
...
new __WEBPACK_IMPORTED_MODULE_0_vue___default.a({
    el: '#invoices',
    template: '<Invoices/>',
    components: { Invoices: __WEBPACK_IMPORTED_MODULE_1__components_Invoices___default.a }
});
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-84eb3346", Component.options)
  } else {
    hotAPI.reload("data-v-84eb3346", Component.options)
  }
...
var update = __webpack_require__(46)("563c0398", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-84eb3346\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Invoices.vue", function() {
     var newContent = require("!!../../../../node_modules/css-loader/index.js!../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-84eb3346\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./Invoices.vue");
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Pagination_vue__ = __webpack_require__(54);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        hasInvoices: function hasInvoices() {
    ...
    methods: {
        ...
        fetchCategories: function fetchCategories() {
            ...
            axios.post('/invoices/categories/list').then(function (response) {
        ...
        fetchVendors: function fetchVendors() {
            ...
            axios.post('/vendors/list').then(function (response) {
                _this3.vendors = response.data;
            }).catch(function (error) {
                console.log(error);
            });
        },
        fetchCustomers: function fetchCustomers() {
            ...
            axios.post('/customers/list').then(function (response) {
        ...
        fetchStatuses: function fetchStatuses() {
            ...
            axios.post('/invoices/statuses/list').then(function (response) {
                _this5.statuses = response.data;
            }).catch(function (error) {
                console.log(error);
            });
        },
      ...
      _vm.hasInvoices
        ? _c(
            ...
            _vm._l(_vm.invoices.data, function(invoice) {
              return _c("tr", [
                _c("td", [_vm._v(_vm._s(invoice.category.name))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(invoice.vendor.name))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(invoice.customer.name))]),
                _vm._v(" "),
                _c("td", [_vm._v(_vm._s(invoice.status.name))]),
                _vm._v(" "),
        ...
        _c("tr", [
              ...
              "select",
              {
                ...
                on: {
                  change: function($event) {
                    ...
                    _vm.selected_vendor = $event.target.multiple
                      ? $$selectedVal
                      : $$selectedVal[0]
                  }
                }
          ...
          _c("td", [
            _c("input", {
              ...
              staticClass: "form-control",
              attrs: { type: "number" },
              domProps: { value: _vm.selected_price },
              on: {
                input: function($event) {
                  if ($event.target.composing) {
                    return
                  }
                  _vm.selected_price = $event.target.value
                }
              }
            })
          ]),
    ...
    _c(
      ...
      [
        _c("pagination", {
          ...
          attrs: { data: _vm.invoices, limit: 3 },
          on: { "pagination-change-page": _vm.fetchInvoices }
        })
      ],
      1
    )
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-84eb3346", module.exports)
  }
}
        ...
        [
          _c(
            "li",
            {
              ...
              class: { pagination__page_disabled: !_vm.data.prev_page_url }
            },
            [
              _c(
                "a",
                {
                  ...
                  on: {
                    click: function($event) {
                      ...
                      _vm.selectPage(--_vm.data.current_page)
                    }
                  }
                },
                [_vm._v("\n            <\n        ")]
          ...
          _vm._l(_vm.getPages(), function(n) {
            return _c(
              ...
              {
                staticClass: "page-item",
                class: { pagination__page_active: n == _vm.data.current_page }
              },
              [
                _c(
                  "a",
          ...
          _c(
            ...
            {
              staticClass: "page-item",
              class: { pagination__page_disabled: !_vm.data.next_page_url }
            },
            [
              _c(
                "a",
